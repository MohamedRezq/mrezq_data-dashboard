      ...
      <div className="max-h-80 w-full px-10 sm:max-w-lg flex justify-center items-center gap-y-5 flex-col">
        ...
        <div className="flex flex-col-reverse gap-x-10 gap-y-3 sm:flex-row items-center justify-around mt-12">
          <Link href="/welcome/select-saas">
            <button className="bg-alto hover:bg-emperor rounded-xl px-5 py-2 text-emperor hover:text-white text-lg">
              Add More Apps
            </button>
          </Link>
          <Link href="/dashboard">
            <button
              className={`bg-hippiegreen bg-opacity-95 hover:bg-opacity-100 rounded-xl px-5 py-2 text-white text-lg`}
            >
              Go to Dashboard
            </button>
          </Link>
