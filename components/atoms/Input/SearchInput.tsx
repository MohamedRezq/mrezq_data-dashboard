  ...
  return (
    <div className="flex items-center relative">
      ...
      <input
        ...
        className="min-w-lg pl-12 py-2 outline-none text-sm bg-transparent border-b border-b-grayish border-opacity-30 w-[304px] placeholder:text-opacity-30 text-opacity-90 text-emperor"
        onChange={(e) => {
