...
export const Integrations = {
  ...
  Zohopeople: {
    AUTH_URL: `${process.env.NEXT_PUBLIC_ZOHOPEOPLE_OAUTH_URL}scope=ZOHOPEOPLE.employee.ALL&client_id=${process.env.NEXT_PUBLIC_ZOHOPEOPLE_CLIENT_ID}&response_type=code&access_type=offline&prompt=consent&redirect_uri=${App_Config.APP_BASE_URL}${process.env.NEXT_PUBLIC_ZOHOPEOPLE_REDIRECT_URL}`,
  },
};
