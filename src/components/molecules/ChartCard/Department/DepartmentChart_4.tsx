...
const DepartmentChart_4 = () => {
  ...
  return (
    <div
      className="col-span-1 rounded-2xl h-fit lg:h-[239px] dark:bg-darkMineShaft dark:text-white  mb-5 text-lightMineShaft w-full font-semibold"
    ...
    >
      ...
      <div
        className={`lg:h-[210px]  h-fit pl-[23px] pr-[36px] bg-wildsand dark:bg-darkMineShaft dark:text-white  flex flex-col gap-y-1 whitespace-nowrap py-5 rounded-br-2xl rounded-bl-2xl`}
      >
